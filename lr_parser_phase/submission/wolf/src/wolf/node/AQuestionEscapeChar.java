...
public final class AQuestionEscapeChar extends PEscapeChar
{
    private TEscapeQuestionMark _escapeQuestionMark_;

    public AQuestionEscapeChar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AQuestionEscapeChar(
    ...
    {
        ((Analysis) sw).caseAQuestionEscapeChar(this);
    }
