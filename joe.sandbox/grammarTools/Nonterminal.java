...
public class Nonterminal implements Symbol {
	...
	public Nonterminal(String name) {
		if (name.isEmpty() || !name.matches("^[A-Z](\\w|_)*$"))
			throw new IllegalArgumentException("Nonterminal: Nonterminal names must be nonempty strings "
					+ "staring with a capital letter followed by zero or more word characters or underscores");
		else
			this.name = name;
	}
