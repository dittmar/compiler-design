...
public final class APrintNativeUnaryOp extends PNativeUnaryOp
{
    private TPrint _print_;

    public APrintNativeUnaryOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrintNativeUnaryOp(
    ...
    {
        ((Analysis) sw).caseAPrintNativeUnaryOp(this);
    }
