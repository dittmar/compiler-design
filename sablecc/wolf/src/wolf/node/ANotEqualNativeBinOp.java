...
public final class ANotEqualNativeBinOp extends PNativeBinOp
{
    private TNotEqual _notEqual_;

    public ANotEqualNativeBinOp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANotEqualNativeBinOp(
    ...
    {
        ((Analysis) sw).caseANotEqualNativeBinOp(this);
    }
