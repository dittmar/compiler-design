...
public final class ALiteralListArgument extends PListArgument
{
    private PList _list_;

    public ALiteralListArgument()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALiteralListArgument(
    ...
    {
        ((Analysis) sw).caseALiteralListArgument(this);
    }
