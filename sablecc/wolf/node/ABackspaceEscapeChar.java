...
public final class ABackspaceEscapeChar extends PEscapeChar
{
    private TEscapeBackspace _escapeBackspace_;

    public ABackspaceEscapeChar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABackspaceEscapeChar(
    ...
    {
        ((Analysis) sw).caseABackspaceEscapeChar(this);
    }
